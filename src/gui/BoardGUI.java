...
/**
 * Shows all the fields an has a little hint line on the bottom of the panel.
 * @author nicky
 *
 */
public class BoardGUI extends JPanel{
	...
	private static Dimension boardsize = new Dimension(800, 400);
...
//				GameBoard.pl2h6.addMouseListener(Gameplay.clickBlue);
		...
		//***		game board shows holes and both kalaha
//				board.setBackground(blue);
				board.setPreferredSize(boardsize);
				board.setMinimumSize(boardsize);
				board.setLayout(flayout);
...
//				yes.addActionListener(Gameplay.yes);
					
		//***		build board
				board.add(undo, gbcb1);
				board.add(yes, gbcb2);
				
				board.add(kalaha2, gbck2);
				board.add(pl2h1, gbcp2h1);
				board.add(pl2h2, gbcp2h2);
				board.add(pl2h3, gbcp2h3);
				board.add(pl2h4, gbcp2h4);
				board.add(pl2h5, gbcp2h5);
				board.add(pl2h6, gbcp2h6);
				
				board.add(spacer, gbcs);
				
				board.add(kalaha1, gbck1);
				board.add(pl1h1, gbcp1h1);
				board.add(pl1h2, gbcp1h2);
				board.add(pl1h3, gbcp1h3);
				board.add(pl1h4, gbcp1h4);
				board.add(pl1h5, gbcp1h5);
				board.add(pl1h6, gbcp1h6);
				
				hint.add(hmsg);
				board.add(hint, gbchint);
