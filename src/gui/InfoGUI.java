...
/**
 * top panel of the main window.
 * shows both player names and has a text field to show game status
 * @author nicky
 *
 */
public class InfoGUI extends JPanel {
	...
	private Dimension infosize = new Dimension(800, 200);
	private Dimension stsize = new Dimension (400, 190);
